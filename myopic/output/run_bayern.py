...
for year in years:
    ...
    plot_tuples = [
        ...
        #(year, 'Bayern', 'CO2'),
        #(year, 'Bayern', 'Elec'),
        #(year, 'Bayern', 'Elec_Space_heating'),
        #(year, 'Bayern', 'Elec_Process_heat_HP'),
        #(year, 'Bayern', 'Elec_Process_heat_elec'),
        #(year, 'Bayern', 'Elec_Charging'),
        #(year, 'Bayern', 'Elec_Rest')
        ]
    ...
    # plotting timesteps
    plot_periods = {
        #'summer_week': timesteps[3001:3168]
        'all': timesteps[1:]
    }
